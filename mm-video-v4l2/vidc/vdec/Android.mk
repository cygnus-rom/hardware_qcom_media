...
libmm-vdec-inc          += $(call project-path-for,media)/mm-video-v4l2/vidc/common/inc
libmm-vdec-inc          += $(call project-path-for,media)/mm-core/inc
libmm-vdec-inc          += $(call project-path-for,media)/libplatformconfig
libmm-vdec-inc          += $(TARGET_OUT_HEADERS)/qcom/display
libmm-vdec-inc          += $(TARGET_OUT_HEADERS)/adreno
libmm-vdec-inc      	+= $(call project-path-for,media)/libc2dcolorconvert
...
libmm-vdec-inc += $(call project-path-for,media)/libstagefrighthw
endif
