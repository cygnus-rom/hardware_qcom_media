...
TARGETS_THAT_SUPPORT_SW_VENC_ROTATION := sdm845 msmpeafowl sdm710 qcs605
...
libmm-venc-inc      += $(call project-path-for,media)/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += $(call project-path-for,media)/mm-core/inc
libmm-venc-inc      += $(call project-path-for,media)/libstagefrighthw
libmm-venc-inc      += $(call project-path-for,media)/libplatformconfig
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/qcom/display
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += $(call project-path-for,media)/libc2dcolorconvert
